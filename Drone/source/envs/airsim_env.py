...
# Assuming the necessary import paths
...
class AirSimEnv(gym.Env):
    def __init__(self, state_dim, action_dim, target_position=np.array([0, 0, -10]), action_frequency=1.0, log_enabled=False,
        ...
        self.icm = ICM(state_dim, action_dim, image_channels=3)  # Update image dimensions
...
if __name__ == '__main__':
    ...
    # Sample code to reset and run the environment without an agent for testing
